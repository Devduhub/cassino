         ...
         if (user.length === 0) {
            ...
            if (createnewuser.affectedRows >= 1) {
               ...
               res.send({
                  status: 1,
                  msg: "SUCCESS",
                  launch_url: `http://m.pgsoft.com:${process.env.PORT || 3000}/${codegame}/index.html?operator_token=Zm9saWFiZXQ=&btt=1&t=${getnewuser[0].token}&or=m.pgsoft.com:${process.env.PORT || 3000}&api=api.pgsoft.com:${process.env.PORT || 3000}`,
            ...
            await apifunctions.setbalanceuserbyid(user[0].id, user_balance)
             ...
             res.send({
                status: 1,
                msg: "SUCCESS",
                launch_url: `http://m.pgsoft.com:${process.env.PORT || 3000}/${codegame}/index.html?operator_token=Zm9saWFiZXQ=&btt=1&t=${user[0].token}&or=m.pgsoft.com:${process.env.PORT || 3000}&api=api.pgsoft.com:${process.env.PORT || 3000}`,
